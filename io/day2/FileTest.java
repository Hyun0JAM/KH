...
public class FileTest {
    ...
    */
    ...
    //  File dir2 = new File("C:/myjava/IONetwork/TestDir"); 와 같다.    
     ...
     // File file2 = new File("C:/myjava/IONetwork/테스트.txt"); 와 같다. 
        ...
        if( !file2.exists() ) { // 해당 파일이 존재하지 않으면 
        	try {
				file2.createNewFile(); // 파일생성하기
				
				System.out.println("테스트.txt 의 상대경로 : " + file2.getPath()); 
				// 테스트.txt 의 상대경로 : 테스트.txt
				
				System.out.println("테스트.txt 의 절대경로 : " + file2.getAbsolutePath()); 
				// 테스트.txt 의 절대경로 : C:\myjava\IONetwork\테스트.txt
