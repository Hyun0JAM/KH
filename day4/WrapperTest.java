...
public class WrapperTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		boolean bool = Character.isLowerCase(chr);
		...
		bool = Character.isDigit('0');
		System.out.println(bool);

		bool = Character.isDigit('d');
		System.out.println(bool);

		bool = Character.isAlphabetic('d');
		System.out.println(bool);

		String age = "26";
		int n =1;
		System.out.println("age +n : " +(age + n)); //age +n : 261

		//문자형으로 되어진 숫자(정수)를 실제 숫자로 변경한다.
		System.out.println("age + n : "+(Integer.parseInt(age)+n)); //pareseInt 숫자형으로 바꿔준다.
		...
		int point = 98;
		System.out.println("point +2 : "+(point+2)); //point +2 : 100
		System.out.println("point +2 : "+(Integer.toString(point)+2)); //point +2 : 982
		System.out.println("point +2 : "+(String.valueOf(point)+2)); //point +2 : 982
