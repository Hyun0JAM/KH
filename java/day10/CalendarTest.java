...
public class CalendarTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		String strMonth2 = month<10?"0"+month:String.valueOf(month+1);
		System.out.println("월(1~12, 0:1월): " + strMonth2);
        ...
        today += " " +currentdate.get(Calendar.HOUR_OF_DAY)+":"+currentdate.get(Calendar.MINUTE)+":"+currentdate.get(Calendar.SECOND);
