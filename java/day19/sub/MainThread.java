...
public class MainThread {
	...
	public static void main(String[] args) {
		...
		System.out.println("* 현재 실행중인 스레드 이름 : "+thr.getName());// 현재 실행중인 스레드 명 : 스레드 이름을 얻어온다.
		// 현재 실행중인 스레드 이름 : main

		System.out.println("* 스레드의 우선순위 : "+thr.getPriority());// 스레드의 우선순위를 알아온다.
		// 스레드의 우선순위 : 5

		System.out.println("* 스레드의 우선순위 : "+Thread.MAX_PRIORITY);// 스레드가 가질수있는 우선순위 최소값
		System.out.println("* 스레드의 우선순위 : "+Thread.MIN_PRIORITY);// 스레드가 가질수있는 우선순위 최대값
		System.out.println("* 스레드의 우선순위 : "+Thread.NORM_PRIORITY);// 스레드가 가질수있는 우선순위 기본값
	}
