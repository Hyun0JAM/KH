/*
     ...
     LinkedList (저장소)
     	(null)유재석(자신의 메모리주소1372)---(앞서 존재하던 메모리 주소1372)엄정화(자신의 메모리주소3236)
     																	   |
     															 (앞서 존재하던 메모리 주소3236)강호동(자신의 메모리주소????) ...
     															 
     ArratList(저장소)
     	유재석(0) 엄정화(1) 강호동(2) 이순신(3) 김태릐(4)
     	//객체 삭제,삽입시 인덱스변경이 필요하므로 부하가 있다.
     	 * 
...
public class LinkedListTest {
	...
	public static void main(String[] args) {
		...
		//    LinkedList 객체 memberList 를 생성하시오.
		...
		// 3. memberList에 저장되어진 모든 회원들의 정보를 출력하세요.
		   ...
		   memberList.add(3, new Member("ailin","qwer1234$","아이린"));
		   
		   System.out.println("==== 새로운 회원 추가후 ====");
		   ...
		   memberList.remove(3); // 특정 인덱스번호(지금은 3)에 위치한 객체 삭제하기 
		   
		   System.out.println("==== 회원 삭제후 ====");
		   ...
		   System.out.println("\n--- 특정 인덱스 위치에 있던 객체를 삭제하고서 새로운 객체로 대체 하기 ---");
		   memberList.set(3, new Member("suji","qwer1234$","수지"));
